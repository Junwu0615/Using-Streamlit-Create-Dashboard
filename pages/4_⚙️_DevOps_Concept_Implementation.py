...
| BUILD | 建置應用程式 | Python / Docker Build | :blue-background[CI Pipeline] / :blue-background[Docker Image] / :blue-background[Docker Hub] |
...
| RELEASE | 版本管理與交付 | GitHub Releases / Docker Images | :blue-background[Git Tag Mapping Docker Image Tags] / :blue-background[Automated Release Process] |
