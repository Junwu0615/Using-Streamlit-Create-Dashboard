...
<div style="width: 100%; overflow: hidden; white-space: nowrap; box-sizing: border-box; background-color: white; padding: 10px; border-radius: 10px; border: 1px solid #ddd;">
    <div style="display: inline-block; animation: marquee 20s linear infinite;">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" alt="Google" height="60px" style="margin: 0 20px;">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/YouTube_Logo_2017.svg/2560px-YouTube_Logo_2017.svg.png" alt="youtube" height="35px" style="margin: 0 20px;">
        <img src="https://pngimg.com/uploads/github/github_PNG23.png" alt="GitHub" height="70px" style="margin: 0 20px;">
...
<div style="width: 100%; overflow: hidden; white-space: nowrap; box-sizing: border-box; background-color: white; padding: 10px; border-radius: 10px; border: 1px solid #ddd;">
    <div style="display: inline-block; animation: marquee 20s linear infinite;">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/London_Metal_Exchange_logo.svg/2560px-London_Metal_Exchange_logo.svg.png" alt="LME" height="75px" style="margin: 0 20px;">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Cboe_Global_Markets_Logo.svg/2560px-Cboe_Global_Markets_Logo.svg.png" alt="CBOE" height="60px" style="margin: 0 20px;">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/NYSE_Logo_2022.svg/2560px-NYSE_Logo_2022.svg.png" alt="NYSE" height="80px" style="margin: 0 20px;">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/CME_Group_Logo.svg/2560px-CME_Group_Logo.svg.png" alt="CME" height="50px" style="margin: 0 20px;">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZAX5ZAEG5xFy8r9PYoHdLTqPbXWoUodYRJg&s" alt="EUREX" height="70px" style="margin: 0 20px;">
        <img src="https://companieslogo.com/img/orig/ASX.AX_BIG-a1970d7d.png?t=1720244490" alt="ASX" height="80px" style="margin: 0 20px;">
        <img src="https://22364887.fs1.hubspotusercontent-na1.net/hub/22364887/hubfs/VettaFi%20Logos/VettaFi_Logo_PURPLE_HEX.png?width=2035&height=484&name=VettaFi_Logo_PURPLE_HEX.png" alt="VettaFi" height="55px" style="margin: 0 20px;">
        <img src="https://i.pinimg.com/736x/94/85/e9/9485e913620577eff748a7b28f263a8b.jpg" alt="TradingView" height="50px" style="margin: 0 20px;">
        <img src="https://i.pinimg.com/736x/25/35/1d/25351d37543b591621eb8e522d81674d.jpg" alt="Investing.com" height="40px" style="margin: 0 20px;">
        <img src="https://d3g3pd9iiem0rf.cloudfront.net/public-eu-central-1/providers/a43209e9-c753-48df-a85d-9e3e55149ec6/brand-logo/Logo_light_2x_d95450c472d9f75d.png" alt="FMP" height="70px" style="margin: 0 20px;">
        <img src="https://www.shutterstock.com/image-illustration/isin-international-security-identification-number-260nw-2197952243.jpg" alt="ISIN" height="80px" style="margin: 0 20px;">
...
<div style="width: 100%; overflow: hidden; white-space: nowrap; box-sizing: border-box; background-color: white; padding: 10px; border-radius: 10px; border: 1px solid #ddd;">
    <div style="display: inline-block; animation: marquee 20s linear infinite;">
        ...
        <img src="https://www.uobam.com.tw/static/media/logo.6558096f.png" alt="大華銀投信" height="50px" style="margin: 0 20px;">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlofzS_7-NlYjEMCP5Yr1Yuqg4h-H57SyMHw&s" alt="新光投信" height="60px" style="margin: 0 20px;">
        ...
        <img src="https://fs-static-web-assets.s3.ap-northeast-1.amazonaws.com/images/market/brands/logo/logo_normal_ezmoney.png" alt="統一投信" height="80px" style="margin: 0 20px;">
        <img src="https://fs-static-web-assets.s3.ap-northeast-1.amazonaws.com/images/market/brands/logo/logo_normal_FSITC.png" alt="第一金投信" height="90px" style="margin: 0 20px;">
        <img src="https://fs-static-web-assets.s3.ap-northeast-1.amazonaws.com/images/market/brands/logo/logo_normal_TSIT.png" alt="台新投信" height="80px" style="margin: 0 20px;">
...
.marquee-content {
    ...
    transform: translateX(50%); /* 設置初始進度為50% */
}
</style>
"""
